...
var testSetup_exports = {};
__export(testSetup_exports, {
  mockConfirmRideUseCaseFactory: () => mockConfirmRideUseCaseFactory,
  mockEstimateRideUseCaseFactory: () => mockEstimateRideUseCaseFactory,
  mockGetRideHistoryUseCaseFactory: () => mockGetRideHistoryUseCaseFactory,
  setupTest: () => setupTest
});
module.exports = __toCommonJS(testSetup_exports);
...
ConfirmRideUseCase = __decorateClass([
  ...
  __decorateParam(0, (0, import_inversify2.inject)(TYPES.RideRepository)),
  __decorateParam(1, (0, import_inversify2.inject)(TYPES.DriverRepository)),
  __decorateParam(2, (0, import_inversify2.inject)(TYPES.GoogleMapsDataSource))
], ConfirmRideUseCase);
...
EstimateRideUseCase = __decorateClass([
  __decorateParam(0, (0, import_inversify3.inject)(TYPES.DriverRepository)),
  __decorateParam(1, (0, import_inversify3.inject)(TYPES.GoogleMapsDataSource))
], EstimateRideUseCase);
...
var mockEstimateRideUseCaseFactory = () => {
  const googleMapsDataSource = new GoogleMapsDataSource();
...
var mockConfirmRideUseCaseFactory = () => {
...
var mockGetRideHistoryUseCaseFactory = () => {
